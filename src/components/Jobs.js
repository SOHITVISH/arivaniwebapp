...
import manag_photo1 from "../img/team/1711725438829.jpg";
import manag_photo2 from "../img/team/1711725438829.jpg";
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row gy-4 align-items-center" data-aos="fade-up">
              ...
              <div className="col-lg-6">
                <p>
                  {" "}
                  We started Arivani Infotech in XYZ. When we started our
                  company, we knew we would be working together with our mobile
                  carrier clients to help increase their top-line revenue.
                </p>
                <p>
                  {" "}
                  We came up with the name Arivani because the definition of a
                  Arivani relationship is one in which organisms, people, or
                ...
                <p>
                  {" "}
                  Since then, Arivani has seen unprecedented growth and is one
                  of the largest and fastest growing VAS companies in India. We
                  have generated multi-million dollars in revenue for our
                  clients and currently service over 20 million customers and
                  growing.
                </p>
                <p>
                  {" "}
                  Our determination to help our clients succeed is only one
                  facet of Arivani. When we started Arivani, we wanted to create
                  a company that not only succeeded financially, we strive to
                  take care of our employees, and to give back to our community.
                  That is why Arivani donates a portion of every dollar we earn
          ...
          <div className="container">
            <div className="section-header">
              ...
              <p>
                ...
                services industry, Arivani's leadership team is dedicated to
              ...
              <div className="col-md-10">
                <div className="member-info">
                  ...
                  <span>Co-Founder & Director</span>
                      <p>
                       Arivani is a visionary Technocrat with 16 Years of
                       experience and has worked with consulting majors & service
                       industries in the field of IT technologies. His
            ...
            <div className="row member d-flex align-items-center mt-4">
              ...
              <div className="col-md-10">
                <div className="member-info">
                  ...
                  <span>Co-Founder & Director</span>
                  <p>
                    Arivani is a visionary and entrepreneur in his own right. He
                  ...
                  <p>
                    {" "}
                    Arivani has extensive multi-functional management experience
