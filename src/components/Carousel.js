  ...
  return (
    <>
      <section id="hero" className="hero d-flex">
        <img className="shape" src={shapeImg} 
        alt="#" />
        <div className="container">
          ...
          >
            <div className="col-lg-7 col-md-12 col-12">
              <h2 data-aos="fade-up">
                Leverage Your Business With Our Expertise
              </h2>
              <blockquote data-aos="fade-up" data-aos-delay="100">
                <p>
                Arivani Technologies Pvt. Ltd. is a Software development company, we provide all the services related to software like ERP/CRM Software, Ecommerce Development, Mobile Development, Web & Mobile Design, and Web Development.
                </p>
              </blockquote>
                  ...
                  <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                                {/* <video width="640" height="360" controls>
                                     <source src="..img/header/vdo1.mp4" type="video/mp4" />
